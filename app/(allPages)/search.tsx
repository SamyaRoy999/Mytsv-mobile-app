...
const Search = () => {
    ...
    const [triggerGlobalSearch, { data: searchResults, isLoading: isSearching }] = useLazyGlobalSearchQuery();
    ...
    const renderSearchHistory = () => {
        if (isLoadingHistory) {
            return <ActivityIndicator size="small" color="#0000ff" style={tw`py-4`} />;
        }
                ...
                {locationHistory.map((item, index) => (
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            } else if (cityData?.data?.some((city: any) => city.name === item)) {
    ...
    return (
        <View style={tw`pt-5 flex-1 bg-primary`}>
            ...
            <View>
                ...
                <View style={tw`pt-4 px-5`}>
                    <TouchableOpacity
                        ...
                        style={tw`flex-row items-center justify-between border border-primaryGray px-6 py-3 rounded-full ${!formData.state ? 'opacity-50' : ''
                            }`}
                    >
                        <Text style={tw`font-poppins text-base`}>
                            {formData.city || 'City'}
            ...
            {/* Search Button */}
            <TouchableOpacity
                style={tw`bg-secondary rounded-full mx-6 mt-8 ${isSearching ? 'opacity-50' : ''}`}
                        ...
                        <View style={tw`max-h-64`}>
                            ...
                            >
                                {isCityLoading ? (
                                    ...
                                    <Text style={tw`text-center font-poppins text-gray-500 py-4`}>
                                        {stateID ? 'No cities available for this state' : 'Please select a state first'}
                                    </Text>
                                ) : (
