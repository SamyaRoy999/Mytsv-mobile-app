...
const paymentOnside = () => {
    ...
    return (
        <ScrollView contentContainerStyle={tw`flex-grow bg-white p-5 justify-center`}>
            <View style={tw`items-center`}>
                <View style={tw`mb-5`}>
                    <SvgXml xml={IconPayment} />
                </View>

                <Text style={tw`text-2xl font-poppinsMedium text-gray-800 text-center mb-4`}>
                    Complete Your Account Setup
                </Text>

                <Text style={tw`text-base font-poppins text-gray-600 text-center mb-8 leading-6`}>
                    Thank you for creating your account! To unlock all features and start using our services, please complete your payment for onsite account creation.
                </Text>
                ...
                <Text style={tw`text-xs font-poppinsLight text-gray-500 text-center mt-3`}>
