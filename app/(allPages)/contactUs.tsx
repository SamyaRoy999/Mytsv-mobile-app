...
const contactUs = () => {
  ...
  return (
    ...
    >
      <HeaderBar />
      <ScrollView
        contentContainerStyle={tw`p-4 mb-6`}
        ...
        <AlertNotificationRoot>
          ...
          <View style={tw`border rounded-xl p-7 mb-4 border-primaryGray`}>
            <View style={tw`flex-row items-center gap-2 `}>
              <Text style={tw`text-base font-poppinsMedium mb-1 `}>
                Get in touch
              </Text>
            </View>
            ...
            <View style={tw`flex-row items-center gap-3 pt-9`}>
              ...
              <Text style={tw`text-base font-poppins `}>{phone}</Text>
            </View>
            <View style={tw`flex-row items-center gap-3 pt-9`}>
              <SvgXml xml={IconLoction} />
              <Text style={tw`text-base font-poppins `}>{address}</Text>
            </View>
          </View>
          <Formik
            initialValues={{
                ...
                <View>
                  <View style={tw`flex-col gap-6 mt-9`}>
                    <View style={tw`relative`}>
                      <View
                        style={tw`bg-primary absolute px-4 flex-row justify-center items-center left-7 font-poppins text-base -top-2 z-10`}
                      >
                      ...
                      {errors.name && (
                        <Text
                          style={tw`text-left pl-6 text-red-700 font-poppins`}
                        >
                          {errors.name}
                        </Text>
                      )}
