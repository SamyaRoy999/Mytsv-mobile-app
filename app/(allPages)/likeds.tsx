...
import { useLazyLikeVideosQuery, useLikeVideosDeleteMutation } from '@/redux/apiSlices/Account/accountSlice';
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <View>
                        ...
                        {/* Header Section */}
                        <View style={tw`flex-row justify-between items-center gap-5 px-5 mb-8 mt-4`}>
                        ...
                        <View style={tw`p-5 relative`}>
                            <LinearGradient
                                style={[tw`rounded-2xl absolute`, { height: _HIGHT * 0.6, width: _Width }]}
                                colors={['#753A88', '#EF4444E5', '#eb7a82', 'transparent', 'transparent']}
                            />
                            <Image
                                source={historypage}
                                style={{ width: _Width * 0.9, height: _HIGHT * 0.3, borderRadius: 20 }}
                            />
                            <View style={tw`flex-row items-center justify-between pt-5 pb-20`}>
                                <View>
                                    ...
                                    <Text style={tw`font-poppinsMedium text-base text-primary`}>{posts.length} videos</Text>
                                </View>
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity onPress={() => router.push(`/details/video/${item.video?.id}`)}>
