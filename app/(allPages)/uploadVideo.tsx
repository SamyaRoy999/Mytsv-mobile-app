...
const UploadVideo = () => {
  ...
  return (
    ...
    >
      {isProcessing && (
        <View
          style={tw`absolute inset-0 bg-black/50 justify-center items-center z-10`}
        >
          <ActivityIndicator size="large" />
      ...
      <AlertNotificationRoot>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Video Upload */}
          <TouchableOpacity
            style={tw`border border-dashed rounded-lg justify-center items-center py-10`}
          >
          ...
          {/* Thumbnail */}
          <View
            style={tw`flex-row items-center border border-primaryGray rounded-2xl mt-5 justify-between px-6 py-3`}
          >
          ...
          <View style={tw`pt-5`}>
            ...
            >
              ...
              >
                Promote for ${priceUploadVideo?.data?.uploading_video} / Month
              </Text>
            </TouchableOpacity>
          </View>
          {promotedOn ? (
                ...
                <View style={tw`p-5`}>
                  ...
                  <View style={tw`flex-row justify-between`}>
                    ...
                    <TouchableOpacity
                      ...
                      style={tw`bg-[#FF5A5F] rounded-full py-3 px-6 w-[48%] opacity-${
                        isProcessing ? "50" : "100"
                      }`}
                    >
                      <Text
