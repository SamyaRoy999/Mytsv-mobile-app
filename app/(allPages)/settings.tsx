...
import { GOOGLEMAPAPIKEY } from "@/googleKey/googleApiKey";
import {
  IconAddsm,
  IconBackLeft,
  IconButtonBack,
...
const Settings = () => {
  ...
  const transformLocations = (backendLocations: any[]) => {
    return (
      backendLocations?.map((loc) => ({
        location: loc.location || "",
        officeType: loc.type === "head-office" ? "Head office" : "Branch",
  ...
  const searchLocations = async (query: string) => {
    ...
    try {
      const response = await axios.get(GOOGLEMAPAPIKEY({ query }));
              ...
              <View>
                ...
                <View style={tw`px-5 pt-5`}>
                  <View style={[tw`relative`, { height: _HIGHT * 0.19 }]}>
                    <TouchableOpacity
                      ...
                      style={tw`absolute z-20 top-3 right-3`}
                    >
                  ...
                  <TouchableOpacity
                    onPress={() => setProfilePicure(true)}
                    style={tw`absolute -bottom-10 left-[55%]`}
                  >
                ...
                <View style={tw`mt-9`}>
                  ...
                  <View style={tw`py-3 px-6`}>
                    <View
                      style={tw`border border-primaryGray flex-col justify-center pl-7 relative rounded-full h-14`}
                    >
                      <Text
                        style={tw`bg-primary w-28 absolute -top-2 text-center left-7`}
                      >
                        Channel name
                      </Text>
                      <TextInput
                    ...
                    {errors.channel_name && touched.channel_name && (
                      <Text style={tw`text-red-700 font-poppins text-sm pl-6`}>
                        {errors.channel_name}
                      </Text>
                    )}
                  </View>
                  ...
                  <View style={tw`py-3 px-6`}>
                    <View
                      style={tw`border border-primaryGray flex-col justify-center pl-7 relative rounded-2xl p-4`}
                    >
                      <Text
                        style={tw`bg-primary w-12 absolute -top-2 text-center left-7`}
                      >
                        Bio
                      </Text>
                      <TextInput
                  ...
                  <View style={tw`py-3 px-6`}>
                    ...
                    >
                      <Text
                        style={tw`bg-primary text-center w-28 absolute -top-2 left-7`}
                      >
                        Services
                      </Text>
                  ...
                  <View style={tw`py-3 px-6`}>
                    ...
                    >
                      <Text
                        style={tw`bg-primary w-40 absolute -top-2 text-center left-7`}
                      >
                        Business locations
                      </Text>
                        ...
                        <View key={index} style={tw`py-2 relative `}>
                          ...
                          {location.showSuggestions &&
                            locationSuggestions.length > 0 && (
                              <View
                                style={tw`absolute top-16 left-0 right-0 bg-primary rounded-lg shadow-lg z-50 max-h-48`}
                              >
                                <ScrollView
                                ...
                                >
                                  {locationSuggestions.map(
                                    (item: any, suggestionIndex: number) => {
                                      return (
                                        <TouchableOpacity
                                        ...
                                        >
                                          ...
                                          <Text
                                            style={tw`font-poppins text-sm text-gray-600 mt-1`}
                                          >
                          ...
                          {location.showOfficeType && (
                            ...
                            >
                              <View style={[tw``, styles.modalContainer]}>
                                <View
                                  style={tw`bg-primary rounded-t-3xl w-full absolute bottom-0`}
                                >
                                  <View
                                  ...
                                  >
                                    <View></View>
                                    <Text
                                      style={tw`font-poppinsMedium text-lg text-primary`}
                                    >
                                      Office Type
                                    </Text>
                                    <TouchableOpacity
                                      onPress={() => {
                                        ...
                                        newLocations[index].showOfficeType =
                                          false;
                                        setFieldValue(
                                          "locations",
                                          newLocations
                                  ...
                                  <View style={tw`py-9 `}>
                                    ...
                                    >
                                      <View
                                        style={tw`mx-5 flex-row  justify-center mb-4 rounded-lg bg-primaryText`}
                                      >
                                        <Text
                                          style={tw`py-5 font-poppins text-lg`}
                                        >
                                          Branch
                                        </Text>
                                      </View>
                                    ...
                                    <TouchableOpacity
                                      onPress={() => {
                                        // Check for existing head office
                                        const hasExistingHeadOffice =
                                        ...
                                        if (hasExistingHeadOffice) {
                                          Toast.show({
                                            ...
                                            title: "Limit Reached",
                                            textBody:
                                              "Only one Head office is allowed",
                                            autoClose: 2000,
                                          });
                                        } else {
                                          const newLocations = [
                                    ...
                                    >
                                      <View
                                        style={tw`mx-5 flex-row justify-center rounded-lg bg-primaryText`}
                                      >
                                        <Text
                                          style={tw`py-5 font-poppins text-lg`}
                                        >
                      ...
                      >
                        ...
                        <Text
                          style={tw`text-primaryText text-base font-poppinsBold`}
                        >
                          Add more
                        </Text>
                      </TouchableOpacity>
                ...
                <View style={tw`py-9`}>
                  ...
                  >
                    <View style={tw`flex-row gap-3 items-center`}>
                      ...
                      <Text style={tw`py-5 font-poppins text-lg`}>
                        Upload new picture
                      </Text>
                    </View>
                  ...
                  >
                    <View style={tw`flex-row gap-3 items-center`}>
                      ...
                      <Text
                        style={tw`py-5 font-poppins text-lg text-secondary`}
                      >
                        Delete picture
                      </Text>
                    </View>
