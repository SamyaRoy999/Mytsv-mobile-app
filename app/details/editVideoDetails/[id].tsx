...
import {
  useMy_videos_detailsQuery,
  useUpdateVideoMutation,
} from "@/redux/apiSlices/MyVideo/myvideoSlice";
import {
  useCategoriesQuery,
  useCityGetQuery,
  useStateGetQuery,
...
const EditVideoDetails = () => {
  ...
  // API CALL
  const { data: singleVideo, refetch: singleVideoRefetch } =
      ...
      <AlertNotificationRoot>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={tw`p-5`}>
            ...
            {type === "link" ? (
              <View style={tw``}>
                <Text style={tw`font-poppinsMedium text-base mb-2`}>
                  YouTube Link
                </Text>
                <TextInput
            ...
            <View style={tw`pt-4`}>
              ...
              >
                <Text style={tw`font-poppins text-base`}>
                  {selectedState || states || "Select State"}
                </Text>
            ...
            <View style={tw`pt-5 `}>
              ...
              >
                <Text
                  style={tw`bg-primary w-14 font-poppins text-center text-base absolute -top-2 left-7`}
                >
                  Tags
                </Text>
            ...
            <TouchableOpacity
              style={tw` flex-row gap-4 w-5/7 items-center border border-[#3B97D3] px-6 rounded-full bg-primary `}
              onPress={pickImage}
            >
              <SvgXml xml={IconReplece} />
              <Text style={tw`font-poppins text-base text-[#3B97D3]`}>
            ...
            <View style={tw``}>
              ...
              >
                <Text style={tw`font-poppins text-base`}>
                  {selectedVisibility || visibilityApi || "Select Visibility"}
                </Text>
                <SvgXml xml={IconErowBack} />
              </TouchableOpacity>
            </View>
            ...
            <View style={tw`mt-6 mb-10`}>
              ...
              >
                <Text
                  style={tw`text-center text-white font-poppinsBold text-lg`}
                >
                  Save changes
                </Text>
              </TouchableOpacity>
